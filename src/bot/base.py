...
def start(message: Message) -> None:
    ...
    bot.send_message(
        ...
        #🎅🏻
        f'\U1F385000 Для регистрации напиши /{CommandsEnum.BASE_LIST.value} и отправь мне свой номер из списка участников.\n'
        #🎁
        f'\U1F381000 Для того, чтобы рассказать твоему Тайному Санте о своих пожеланиях, напиши /{CommandsEnum.PERSONAL_WISH.value}.'
        #⛄
        f'\U26C40000 Для того, чтобы я напомнил тебе всю информацию о твоем подопечном напиши /{CommandsEnum.PERSONAL_ME.value}. Рекомендую обязательно сделать это через пару дней: возможно, за это время он придумает и добавит свое пожелание.))'
        #❓
        f'\U27530000 Список всех команд можно увидеть, если напишешь /{CommandsEnum.BASE_HELP.value}.',
        reply_markup=markup,
    )
