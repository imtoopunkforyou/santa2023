...
def start(message: Message) -> None:
    ...
    bot.send_message(
        ...
        f'Введи команду /{CommandsEnum.PERSONAL_WISH.value}, чтобы сделать это.\n'
        f'Если хочешь, чтобы я напомнил всю информацию о твоем подопечном - просто напиши мне /{CommandsEnum.PERSONAL_ME.value}\n'
        f'С помощью команды /{CommandsEnum.BASE_HELP.value} можешь увидеть список всех доступных команд',
        reply_markup=markup,
    )
